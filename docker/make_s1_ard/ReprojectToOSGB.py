...
from docker.make_s1_ard.CheckOutputFilesExist import CheckOutputFilesExist 
            ...
            if not self.testProcessing:
                try:
                    subprocess.check_output(
                        "gdalwarp -overwrite -s_srs EPSG:32630 -t_srs EPSG:27700 -r bilinear -dstnodata 0 -of GTiff --config CHECK_DISK_FREE_SPACE NO %s %s" % (outputFile, self.changeWgsToOsgb(outputFile)), 
